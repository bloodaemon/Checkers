OBJS = ArrayStack.o Captured.o Board.o Node.o LinkedStack.o LinkedQueue.o Action.o ActionNode.o ActionQueue.o GameTreeNode.o PostOrderIterator.o Timer.o GameTree.o Game.o Checkers.o
CC = g++
DEBUG = -g
CFLAGS = -Wall -c $(DEBUG)
LFlAGS = -Wall $(DEBUG)
